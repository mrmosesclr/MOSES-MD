...
async function startXeonBotInc() {
    ...
    XeonBotInc.ev.on('connection.update', async (s) => {
        ...
        if (connection == "open") {
            ...
            await delay(1999)
            console.log(chalk.blue(`\n\n                  ${chalk.bold.red(`[ ${global.botname || '𝙻𝙰𝙳𝚈𝙱𝚄𝙶-𝙼𝙳'} ]`)}\n\n`))
            console.log(chalk.cyan(`< ================================================== >`))
            console.log(chalk.star(`\n${global.themeemoji || '•'} YT CHANNEL: MOSES-MD`))
            console.log(chalk.star(`${global.themeemoji || '•'} GITHUB: mrmosesclr`))
            console.log(chalk.star(`${global.themeemoji || '•'} WA NUMBER: ${owner}`))
            console.log(chalk.star(`${global.themeemoji || '•'} CREDIT: MR MOSES CLR`))
            console.log(chalk.red(`${global.themeemoji || '•'} 🤖 Bot Is Connected Successfully! ✅`))
        }
        if (
            connection === "close" &&
            lastDisconnect &&
