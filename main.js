...
cost  imagecommand = require('./commands/image')
cost versecommand = require('./commands/verse')
...
async function handleMessages(sock, messageUpdate, printLog) {
    try {
        ...
        /*  // Basic message response in private chat
          if (!isGroup && (userMessage === 'hi' || userMessage === 'hello' || userMessage === 'bot' || userMessage === 'hlo' || userMessage === 'hey' || userMessage === 'friend')) {
              await sock.sendMessage(chatId, {
        ...
        const adminCommands = ['.mute', '.unmute', '.ban', '.unban', '.promote', '.demote','warn','rent', 'invite','.kick', '.tagall', '.antilink'];
        const isAdminCommand = adminCommands.some(cmd => userMessage.startsWith(cmd));

        // List of owner commands
        const ownerCommands = ['.mode', '.autostatus', '.antidelete', '.block/report', '.unblock', '.cleartmp', 'pair/rent', '.setpp', 'restart', '.clearsession'];
